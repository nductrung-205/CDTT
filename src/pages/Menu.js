    ...
    const fetchData = async () => {
      try {
        ...
        const productsRes = await fetch(
          "https://food-delivery-backend-1-nyzt.onrender.com/api/products"
        );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <h1
            onClick={() => navigate("/")}
            className="text-2xl font-bold text-orange-600 cursor-pointer hover:text-orange-700 transition"
          >
            🍜 Food Order
          </h1>
        </div>
